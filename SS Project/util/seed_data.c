...
int main()
{
    ...
    Customer customers[] = {
        {1, 100.0, "Raj", "1234", True, False, ""},
        {2, 200.5, "Yash", "1234", True, False, ""},
        {3, 300.25, "Prem", "1234", True, False, ""},
        {4, 500, "Meena", "1234", False, False, ""}};

    Employee employees[] = {
        {MANAGER, 1, "Nilesh", "1234"},
        {REGULAR, 2, "Pankaj", "1234"}};

    Admin admin = {1, "Shubham", "1234", False};
